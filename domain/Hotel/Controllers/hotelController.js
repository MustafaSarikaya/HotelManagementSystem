...
exports.create_hotel_chain = (req, res, next) => {
    res.send('respond with a resource');
}

// GET /chain/:chain_id
// Fetch hotel chain details
exports.fetch_hotel_chain_details = (req, res, next) => {
    res.send('respond with a resource');
}
...
// GET /chain/:chain_id/hotel/:hotel_id
// Fetch hotel details
exports.fetch_hotel_details = (req, res, next) => {
    res.send('respond with a resource');
}

// GET /chain/:chain_id/hotel/
// Fetch all hotels of a chain
exports.fetch_all_hotels = (req, res, next) => {
    res.send('respond with a resource');
}
